...
"""
The Gothons of Planet Percel #25 have invaded your ship and destroyed your
...
one Gothon joke you know: Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr,
fur fvgf nebhaq gur ubhfr. The Gothon stops, tries not to laugh, then busts out
...
Gothons that might be hiding. It's dead quite, too quite. You stand up and run
...
The code is 3 digits. HINT: 4x4x10.
""")

the_bridge = Room("The Bridge",
"""
The container clicks open and seal breaks, letting gas out. You grab the neutron
bomb and run as fast as you can to the bridge where you must place it in the
right spot.
...
an even uglier clown costume than the last. They haven't pulled their arm and
...
"""
You jump into pod 4 and hit the eject button. The pod easily slides out into
...
def name_room(room):
    """
    Same possible security problem. Can you trust the room?
